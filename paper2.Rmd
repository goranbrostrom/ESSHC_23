...
we use a data set from Västerbotten in northern Sweden, covering the years 1861--1950, see 
Figure \@ref(fig:vbmap).

```{r vbmap, fig.cap="Västerbotten."}
...
```{r scaniamap, fig.cap = "Skåne."}
knitr::include_graphics("Slides/myfigs/scania.png")
```

This dataset covers five parishes i n Skåne 1710--1800 [@sedd].
