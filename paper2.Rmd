...
```{r plotperiod, fig.cap = "By calendar month, period data, Västerbotten 1861-1950.", fig.height = 9, eval = TRUE}
...
and it shows off in that in all months the suggested models fit well, here shown by the
...
Often the Bourheois-Pichat method is applied to tabular data. The most extreme case is
...
is $g(365) - g(28) \approx 297$ "g-units". 
