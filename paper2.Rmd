...
the function `risksets` in the **R** package `eha` we can get Table \@ref(tab:risksets).
...
This is an interesting case because it appears as if the data quality is low since 
