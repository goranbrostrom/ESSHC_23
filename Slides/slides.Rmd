...
Given that the exogenous mortality follows an Exponential distribution on the log-cube scale, it follows that the cumulative hazards function on the natural time scale is
...
## Exogenous mortality on the normal time scale
